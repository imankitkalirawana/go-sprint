              ...
              >
                ...
                >
                  <div className="h-ful relative flex items-center">
                    <LazyMotion features={domAnimation}>
                      <m.div animate={status} className="relative">
                        <m.div
                          className={cn(
                            'relative flex h-[34px] w-[34px] items-center justify-center whitespace-nowrap rounded-full border-medium text-large font-semibold text-default-foreground',
                            {
                  ...
                  <div className="max-w-full flex-1 text-start">
                    <div
                      className={cn(
                        'whitespace-nowrap text-small font-medium text-default-foreground transition-[color,opacity] duration-300 group-active:opacity-80 lg:text-medium',
                        {
